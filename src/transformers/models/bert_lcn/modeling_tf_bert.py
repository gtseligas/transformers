...
from .configuration_bert import LCNBertConfig
...
class TFBertEmbeddings(keras.layers.Layer):
    ...
    def __init__(self, config: LCNBertConfig, **kwargs):
...
class TFBertLMPredictionHead(keras.layers.Layer):
    def __init__(self, config: LCNBertConfig, input_embeddings: keras.layers.Layer, **kwargs):
        super().__init__(**kwargs)
...
class TFBertMainLayer(keras.layers.Layer):
    config_class = LCNBertConfig

    def __init__(self, config: LCNBertConfig, add_pooling_layer: bool = True, **kwargs):
        super().__init__(**kwargs)
...
class TFBertModel(TFBertPreTrainedModel):
    def __init__(self, config: LCNBertConfig, add_pooling_layer: bool = True, *inputs, **kwargs):
...
class TFBertForPreTraining(TFBertPreTrainedModel, TFBertPreTrainingLoss):
    ...
    def __init__(self, config: LCNBertConfig, *inputs, **kwargs):
        super().__init__(config, *inputs, **kwargs)
