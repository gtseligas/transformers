...
from .configuration_gpt2 import GPT2LCNConfig


logger = logging.get_logger(__name__)

_CHECKPOINT_FOR_DOC = "openai-community/gpt2"
_CONFIG_FOR_DOC = "GPT2LCNConfig"
...
GPT2_START_DOCSTRING = r"""
    ...
    Parameters:
        config ([`GPT2LCNConfig`]): Model configuration class with all the parameters of the model.
    ...
    def forward(
        ...
        **kwargs,
        ...
        transformer_outputs = self.transformer(
            ...
            use_cache=use_cache,
            output_attentions=output_attentions,
            output_hidden_states=True, # For LCN we always want to get intermediate states
        ...
        if self.model_parallel:
            ...
            all_hidden_states = [h.to(self.lm_head.weight.device) for h in all_hidden_states]

        # Create the LCN sum
        sum_hidden_states = all_hidden_states[0]
        for h in all_hidden_states[1:]:
            sum_hidden_states = sum_hidden_states + h
        lm_logits = self.lm_head(sum_hidden_states)
